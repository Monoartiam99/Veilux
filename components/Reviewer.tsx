                  ...
                  {result.issues.map((issue, idx) => {
                    ...
                    return (
                      <div key={idx} className={`bg-white/[0.01] border ${style.border} p-8 rounded-xl ${style.hoverBorder} transition-all duration-500 group`}>
                        ...
                        <div className={`p-5 border rounded-lg relative transition-all duration-500 ${style.suggestion}`}>
                          ...
                          <button 
                            ...
                            className="absolute top-5 right-5 text-[8px] font-black uppercase tracking-[0.3em] text-gray-600 hover:text-white transition-colors"
                          >
