      ...
      <div className="relative w-full max-w-lg transition-all duration-300 transform scale-100 opacity-100">
        ...
        <div className="relative iso-card rounded-2xl overflow-hidden border-white/10 shadow-[0_0_100px_rgba(99,102,241,0.2)] bg-[#0a0a0a]">
          ...
          <div className="bg-white/5 px-10 py-8 border-b border-white/5 flex items-center justify-between">
            ...
            <button 
              onClick={onClose}
              className="w-10 h-10 rounded-sm border border-white/10 flex items-center justify-center text-gray-500 hover:text-white transition-all hover:bg-white/5 hover:border-indigo-500/50"
            >
          ...
          <div className="p-10 space-y-8">
            ...
            <div className="space-y-4">
              <button 
                ...
                className="w-full flex items-center justify-center gap-4 bg-white/5 border border-white/10 hover:border-indigo-500/50 hover:bg-indigo-500/5 text-white py-4 rounded-sm transition-all group relative overflow-hidden"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="space-y-6">
                {mode === 'signup' && (
                  <div className="space-y-2 group">
                    ...
                    <input 
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-sm px-5 py-4 text-sm text-white focus:outline-none focus:border-purple-500/50 focus:bg-purple-500/5 transition-all placeholder:text-gray-800"
                      value={formData.name}
                ...
                <div className="space-y-2 group">
                  ...
                  <input 
                    ...
                    className={`w-full bg-white/5 border border-white/10 rounded-sm px-5 py-4 text-sm text-white focus:outline-none transition-all placeholder:text-gray-800 ${mode === 'signup' ? 'focus:border-purple-500/50 focus:bg-purple-500/5' : 'focus:border-indigo-500/50 focus:bg-indigo-500/5'}`}
                ...
                <div className="space-y-2 group">
                  <div className="flex justify-between items-center">
                    ...
                    {mode === 'login' && (
                      <button type="button" className="text-[8px] font-black text-indigo-500/60 uppercase tracking-widest hover:text-indigo-400">Recovery?</button>
                    )}
                  </div>
                  <input 
                    type="password"
              ...
              <div className="relative group">
                ...
                <button 
                  type="submit"
                  className={`relative w-full py-5 rounded-sm font-black text-[10px] tracking-[0.4em] uppercase transition-all shadow-xl active:scale-[0.98] ${
                    mode === 'signup' 
              ...
              <div className="text-center">
                <button 
                  ...
                  className={`text-[9px] font-black uppercase tracking-[0.2em] transition-colors ${mode === 'signup' ? 'text-indigo-400 hover:text-indigo-300 underline underline-offset-4' : 'text-purple-400 hover:text-purple-300 underline underline-offset-4'}`}
                >
